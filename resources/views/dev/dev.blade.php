...
<body>
    ...
    <div class="card p-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card p-4 m-2">
                    <label class=" text-center pb-3" for="">تغییر وضعیت دانشجو به در حال اجرا</label>
                    <form method="post" action="{{ route('devTool') }}">
                        @csrf
                        <input type="hidden" name="workingStudent" value="1">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">شماره دانشجویی</label>
                            <input type="text" class="form-control" id="exampleInputEmail2"
                                aria-describedby="emailHelp" placeholder="شماره دانشجویی" name="in">
            ...
            <div class="col-md-4">
                <div class="card p-4 m-2">
                    <label class=" text-center pb-3" for="">تایید کردن دانشجو</label>
                    <form method="post" action="{{ route('devTool') }}">
                        @csrf
                        <input type="hidden" name="verifyStudent" value="1">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">شماره دانشجویی</label>
                            <input type="text" class="form-control" id="exampleInputEmail2"
                                aria-describedby="emailHelp" placeholder="شماره دانشجویی" name="in">
            ...
            <div class="col-md-4">
                <div class="card p-4 m-2">
                    <label class=" text-center pb-3" for="">عدم تایید کردن دانشجو</label>
                    <form method="post" action="{{ route('devTool') }}">
                        @csrf
                        <input type="hidden" name="unVerifyStudent" value="1">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">شماره دانشجویی</label>
                            <input type="text" class="form-control" id="exampleInputEmail2"
                                aria-describedby="emailHelp" placeholder="شماره دانشجویی" name="in">
            ...
            <div class="col-md-4">
                <div class="card p-4 m-2">
                    <label class=" text-center pb-3" for="">تغییر وضعیت پیش ثبت نام برای دانشجو به انجام شده</label>
                    <form method="post" action="{{ route('devTool') }}">
                        @csrf
                        <input type="hidden" name="doStudentPreReg" value="1">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">شماره دانشجویی</label>
                            <input type="text" class="form-control" id="exampleInputEmail2"
                                aria-describedby="emailHelp" placeholder="شماره دانشجویی" name="in">
            ...
            <div class="col-md-4">
                <div class="card p-4 m-2">
                    <label class=" text-center pb-3" for="">تغییر وضعیت پیش ثبت نام برای دانشجو به انجام نشده</label>
                    <form method="post" action="{{ route('devTool') }}">
                        @csrf
                        <input type="hidden" name="unDoStudentPreReg" value="1">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">شماره دانشجویی</label>
                            <input type="text" class="form-control" id="exampleInputEmail2"
                                aria-describedby="emailHelp" placeholder="شماره دانشجویی" name="in">
